...
const addEmailStyles = (html) => {
  ...
  styledHtml = styledHtml.replace(
    /<a(\s[^>]*)?>/g,
    '<a style="color: #000000; text-decoration: none; border-bottom: 1px solid #000000; padding-bottom: 1px;"$1>',
  );
        ...
        ${
          ...
          <div style="margin-top: 8px; font-size: 13px;">
            <a href="${attachment.url}" 
               style="color: #000000; text-decoration: none; border-bottom: 1px solid #000000; padding-bottom: 1px;"
               target="_blank">
      ...
      <td style="padding: 0; vertical-align: top;">
        <div style="color: #333; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
          ...
          <div style="margin-top: 12px; font-size: 14px;">
            ...
            ${email ? `<div style="margin-bottom: 4px;"><span style="color: #666;">Email:</span> <a href="mailto:${email}" style="color: #000000; text-decoration: none;">${email}</a></div>` : ''}
            ${website ? `<div style="margin-bottom: 4px;"><span style="color: #666;">Website:</span> <a href="${website}" style="color: #000000; text-decoration: none;">${website}</a></div>` : ''}
